...
//album.title = @"Photos of Earth"; photo.album = album;
//NSLog( @"photo title: %@", photo.filePath );
//NSLog( @"album title: %@", album.title );
//NSLog( @"Photos in '%@': %lu", album.title, album.photos.count );

//    CBMainWindow theWindow = [[CBMainWindow alloc] init];

//    [window sh]

//    [theWindow]

    [CBMainWindow initialize];
}
...
// Returns the directory the application uses to store the Core Data store file. This code uses a directory named "O2.Gallery" in the user's Application Support directory.
- (NSURL *)applicationFilesDirectory
{
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSURL *appSupportURL = [[fileManager URLsForDirectory:NSApplicationSupportDirectory inDomains:NSUserDomainMask] lastObject];
    return [appSupportURL URLByAppendingPathComponent:@"O2.Gallery"];
}
